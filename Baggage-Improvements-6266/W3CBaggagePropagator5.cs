...
internal class W3CBaggagePropagator5 : IContextInjector, IContextExtractor
{
    ...
    public static readonly W3CBaggagePropagator5 Instance = new();

    private W3CBaggagePropagator5()
    {
    }
