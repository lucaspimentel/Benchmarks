...
internal class W3CBaggagePropagator3 : IContextInjector, IContextExtractor
{
    ...
    internal static string CreateHeader(Baggage baggage, int maxBaggageItems = DefaultMaximumBaggageItems, int maxBaggageLength = DefaultMaximumBaggageBytes)
    {
